...
namespace Talegen.MK.InTouch.Models.Customers.Details
{
    ...
    /// <summary>
    /// This class represents a customer profile question detail model.
    /// </summary>
    ...
    public class CustomerProfileQuestionDetail : CustomerProfileQuestion
    {
        /// <summary>
        /// Gets or sets the options.
        /// </summary>
        /// <value>The options.</value>
        public new List<CustomerProfileQuestionOptionDetail> Options { get; set; } = new List<CustomerProfileQuestionOptionDetail>();
    }
}